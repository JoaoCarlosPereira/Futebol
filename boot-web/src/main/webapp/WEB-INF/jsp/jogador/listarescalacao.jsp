	  ...
	  <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
		<div class="container-fluid">
		  <div class="navbar-wrapper">
			<a class="navbar-brand" href="#pablo">Escalação do time</a>
		  </div>
			...
			<div class="col-md-8">
			  <div class="card">
				<div class="card-header card-header-primary">
				  <h4 class="card-title">Escalação do time</h4>
				  <p class="card-category">Jogadores escalados</p>
				</div>
				<div class="card-body">
                  <div class="col-md-12">
                            ...
                            <tbody>
		                    	<c:forEach items="${jogadores}" var="jogador">
		                    		<tr>
		                    			...
		                    			<td><a href="/futebol/jogador/${jogador.codigo}"><button type="button" class="btn btn-primary pull-right CorVerde">Editar perfil</button></a></td>
										<td><a href="/futebol/escalacao/deletar/${jogador.codigo}"><button type="button" class="btn btn-primary pull-right CorVerde">Remover do time</button></a></td>
		                    		</tr>
		                    	</c:forEach>						
                            </tbody>
                          </table>
