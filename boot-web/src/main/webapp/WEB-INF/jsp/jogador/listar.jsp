			...
			<div class="col-md-8">
			  <div class="card">
				<div class="card-header card-header-primary">
				  ...
				  <p class="card-category">Times cadastrados</p>
				</div>
				<div class="card-body">
                  <div class="col-md-12">
                            ...
                            <tbody>
		                    	<c:forEach items="${times}" var="time">
		                    		<tr>
		                    			<td>${time.codigo}</td>
		                    			<td>${time.nome}</td>
		                    			<td><a href="/futebol/time/${time.codigo}"><button type="button" class="btn btn-primary pull-right CorVerde">Editar time</button></a></td>
										<td><a href="/futebol/escalacao/${time.codigo}"><button type="button" class="btn btn-primary pull-right CorVerde">Ver escalação</button></a></td>
		                    		</tr>
		                    	</c:forEach>						
                            </tbody>
                          </table>
